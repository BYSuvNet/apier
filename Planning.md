...
(* Grundläggande begrepp och funktion för API:er, endpoints, parametrar)
(* Verktyg för att testa och använda API:er, Postman eller liknande)
...
* APIdokumentation
* Workshop 
    * Tänk igenom er dag från hemmet till skolan, vilka digitala plattformar stöter ni på och vilka APIer kan ni tänka er att de använder?
